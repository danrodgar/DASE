...
## Basic Plots
    ...
    + **Boxplot**: The boxplot is used to summarize data succinctly, quickly displaying if the data is symmetric or has suspected outliers.  ![](./figures/boxplotexp.png)
...
## Running Example 
  ...
  - Read the _Telecom1_ dataset and print out the summary statistics with the command `summary`
...
### Example with the China dataset (Promise Repository)
