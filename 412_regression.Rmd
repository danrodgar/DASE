...
- **Linear Regression** is one of the oldest and most known predictive methods. As its name says, the idea is to try to fit a linear equation between a dependent variable and an independent, or explanatory, variable. Multiple linear regression uses 2 or more independent variables for building a model <https://www.wikipedia.org/wiki/Linear_regression>.
...
### Linear regression in Effort estimation
