...
-   [R coding style](https://google.github.io/styleguide/Rguide.html)

-   [R-Bloggers](https://www.r-bloggers.com/)

-   Getting help in R

    -   [RStudio cheat sheet](https://posit.co/resources/cheatsheets/)
    -   [Base R cheat sheet](https://posit.co/resources/cheatsheets/)
    -   [Advanced R cheat sheet](https://posit.co/resources/cheatsheets/)
    -   [Data Visualization cheat sheet](https://posit.co/resources/cheatsheets/)
    -   [R Markdown cheatsheet](https://posit.co/resources/cheatsheets/)
    -   [Quarto Authoring Basics](https://quarto.org/docs/authoring/markdown-basics.html)
    -   [Python with R and Reticulate Cheatsheet](https://posit.co/resources/cheatsheets/)
    -   [tidymodels](https://posit.co/resources/cheatsheets/)
    -   [All cheatsheets and translations](https://posit.co/resources/cheatsheets/)
    -   `help("    ")` command  
...
-   Four \# ('\#\#\#\#') create an *environment* in RStudio. An environment binds a set of names to a set of values. You can think of an environment as a bag of names.
    ...
    -   [Environment basics](https://adv-r.hadley.nz/environments.html#env-basics)
