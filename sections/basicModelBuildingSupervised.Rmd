...
For example, using Binary Logistic Regression (BLR)
...
```{r warning=FALSE}
# logit regression
glmModel <- train (bugs ~ ., data=jdt.train, method="glm")
glmModel
```

TO do. Draw the results

results <- predict(glmModel, jdt.test, type = "raw")
head(results,3)
