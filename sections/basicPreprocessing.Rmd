...
There is a vast body of literature on outlier detection, and several definitions of outlier exist A particularly
easy-to-implement example is the method of
Hiridoglou and Berthelot 16 for positive observations.
...
score function ℎ(𝑥) grows as 1/𝑥 as 𝑥 approaches zero
and grows linearly with 𝑥 when it is larger than 𝑥
