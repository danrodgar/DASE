...
## Modern Package Equivalents

This book includes examples accumulated over multiple years. Some packages are
kept for pedagogical continuity, but modern projects should generally prefer the
following ecosystem updates:
...
Packages still used in some examples (`foreign`, `FSelector`, `tm`, `vioplot`,
`UsingR`) remain for compatibility with historical datasets and classroom
material. They can be progressively replaced as equivalent examples are added.
...
```{r funhist2df-example, eval=FALSE}
...
Type in the console (change names as you wish):
...
8. Do whatever you wish with the data. In this case we simply combine two datasets. Use the following script as your `data-raw/dfaandb.R`:

```{r dfaandb-script, eval=FALSE}
...
## Popular R Packages for Data Mining and Machine Learning {#sec-popular-packages}
...
### Modern ML Ecosystems

| Package | Purpose | Install |
|---------|---------|---------|
| [tidymodels](https://www.tidymodels.org/) | Unified tidy ML framework (replaces caret) | CRAN |
| [mlr3](https://mlr3.mlr-org.com/) | Modular ML framework with pipelines | CRAN |
| [caret](https://topepo.github.io/caret/) | Classic unified interface (legacy) | CRAN |

### Classification and Regression

| Package | Purpose | Install |
|---------|---------|---------|
| [randomForest](https://cran.r-project.org/package=randomForest) | Random forest | CRAN |
| [ranger](https://cran.r-project.org/package=ranger) | Fast random forest | CRAN |
| [xgboost](https://xgboost.readthedocs.io/) | Gradient boosting | CRAN |
| [lightgbm](https://lightgbm.readthedocs.io/) | Fast gradient boosting | CRAN |
| [e1071](https://cran.r-project.org/package=e1071) | SVM, naive Bayes | CRAN |
| [glmnet](https://glmnet.stanford.edu/) | Regularised regression (ridge, lasso) | CRAN |
| [rpart](https://cran.r-project.org/package=rpart) | Decision trees | CRAN |

### Unsupervised Learning

| Package | Purpose | Install |
|---------|---------|---------|
| [cluster](https://cran.r-project.org/package=cluster) | k-means, PAM, hierarchical clustering | CRAN |
| [dbscan](https://cran.r-project.org/package=dbscan) | Density-based clustering | CRAN |
| [factoextra](https://rpkgs.datanovia.com/factoextra/) | PCA and clustering visualisation | CRAN |
| [arules](https://cran.r-project.org/package=arules) | Association rule mining | CRAN |
| [arulesViz](https://cran.r-project.org/package=arulesViz) | Association rule visualisation | CRAN |

### Feature Engineering and Selection

| Package | Purpose | Install |
|---------|---------|---------|
| [recipes](https://recipes.tidymodels.org/) | Pre-processing pipelines (tidymodels) | CRAN |
| [Boruta](https://cran.r-project.org/package=Boruta) | Feature selection via random forest | CRAN |
| [FSelectorRcpp](https://cran.r-project.org/package=FSelectorRcpp) | Information-gain-based selection | CRAN |
| [corrplot](https://taiyun.github.io/corrplot/) | Correlation matrix visualisation | CRAN |

### Text Mining and NLP

| Package | Purpose | Install |
|---------|---------|---------|
| [tidytext](https://www.tidytextmining.com/) | Tidy text analysis | CRAN |
| [text2vec](http://text2vec.org/) | Fast text vectorisation, topic models | CRAN |
| [quanteda](https://quanteda.io/) | Comprehensive NLP framework | CRAN |
| [tm](https://cran.r-project.org/package=tm) | Classic text mining (legacy) | CRAN |

### Network Analysis

| Package | Purpose | Install |
|---------|---------|---------|
| [igraph](https://igraph.org/r/) | General graph analysis | CRAN |
| [ggraph](https://ggraph.data-imaginist.com/) | Network visualisation (ggplot2-based) | CRAN |
| [tidygraph](https://tidygraph.data-imaginist.com/) | Tidy graph manipulation | CRAN |

## Further Information

- [Version Control in Posit IDE](https://docs.posit.co/ide/user/ide/guide/tools/version-control.html)
...
- [Create a Package from a Single R Markdown with `fusen`](https://rtask.thinkr.fr/fusen-create-a-package-from-a-single-rmarkdown-file/)
