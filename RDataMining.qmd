...
Popular packages ():
 ...
 + e1071 Functions for latent class analysis, short time Fourier transform, fuzzy clustering, support vector machines, shortest path computation, bagged clustering, naive Bayes classifier etc. 
  ...
  + nnet Feed-forward Neural Networks and Multinomial Log-Linear Models
    ...
    + ranger Fast implementation of random forests for classification and regression

    + tidymodels A modern ecosystem for modeling workflows, tuning and evaluation
  
  + kernlab Kernel-based Machine Learning Lab

  + glmnet Lasso and elastic-net regularized generalized linear models

    + yardstick Metrics and diagnostic summaries for model evaluation
  ...
  + tree Classification and regression trees
    ...
    + discrim Classification models integrated with tidymodels
